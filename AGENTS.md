...
| `phone_agent/v2/capabilities.py` | Owns the five assembly seams, nine built-in lifecycle specs, cap-id/mode reconciliation, and zero-residue release bookkeeping. |
